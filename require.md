...
8.2 项目文档 (README)
根目录下需提供README.md，包含以下内容：
1. 基本信息：姓名(陈固沛)，学号（251220107），项目各阶段完成度。
...
8.3 AI 使用说明
利用AI辅助是被鼓励的，但必须完全掌控代码。文档中须单设一节”AI使用说明”：
• 项目规划：说明如何构思并将项目拆分交由AI辅助。
• 核心代码解析：挑出至少两个由AI辅助生成的核心模块（寻路路径和包括刺客技能判定的每个回合判定过程），用自己的话详细解释其
运作原理。若验收时发现代码存在复杂的AI生成痕迹却无法解释，将面临严重扣
分。